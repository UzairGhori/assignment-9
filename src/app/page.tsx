  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex pt-10 ">
        <div className="pl-8">
          <h1 className="whitespace-nowrap text-center text-[2rem] font-extrabold leading-10 tracking-wider  text-main sm:text-5xl sm:leading-none md:text-left text-blue-800 lg:text-6xl  mt-0">
            Governor Sindh
          </h1>
          <h1 className="whitespace-nowrap text-center text-[1.5rem] font-normal leading-[2rem] tracking-wider text-main sm:text-4xl sm:leading-[3rem] md:text-left text-blue-800 lg:text-[2.5rem]">
            Kamran Khan Tessori
          </h1>
          ...
          <p className="my-5 whitespace-nowrap text-center text-[1.25rem] font-extrabold text-main sm:text-3xl text-blue-900 md:text-left">
            Earn up to $5,000 / month
          </p>
          <p className="my-5 w-full text-center text-[2.25rem] font-bold tracking-wider text-main sm:text-3xl md:w-[80%] md:text-left text-blue-900">
            Now admissions are <br /> open in Hyderabad
          </p>
          <div className="mb-7 mt-5 flex flex-col items-center sm:mt-10 sm:flex-row sm:gap-5 md:mb-0">
            <a
              className="w-full text-white bg-blue-900 rounded-md md:w-auto"
              href="/Apply"
            >
            ...
            <div className="mt-4 flex w-full flex-col items-center sm:mt-0">
              ...
              <div className="text-center text-1xl font-semibold text-blue-900 tracking-wider text-main sm:mb-0 sm:text-sm">
